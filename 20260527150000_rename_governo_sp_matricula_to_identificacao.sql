-- Migration: Rename numero_matricula to identificacao in base_consulta_governo_sp
...
BEGIN
    IF EXISTS (
        ...
        WHERE table_schema = 'public' 
          AND table_name = 'base_consulta_governo_sp' 
          AND column_name = 'numero_matricula'
    ) THEN
        ALTER TABLE public.base_consulta_governo_sp RENAME COLUMN numero_matricula TO identificacao;
    END IF;
END $$;
