...
export function AdminDashboard({ 
  ...
  // Lógica do Painel Financeiro e Estratégico removida temporariamente para reconstrução incremental
    ...
    <div className="space-y-8">
      ...
      {activeTab === 'financeiro' && (
        <motion.div
          ...
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          className="min-h-[400px] flex items-center justify-center bg-white rounded-[28px] border border-slate-100 p-8 shadow-sm"
        >
          <div className="text-center space-y-3">
            ...
            <p className="text-[11px] font-extrabold text-[#1C2643] uppercase tracking-widest">Painel Financeiro & Estratégico</p>
            <p className="text-xs text-slate-400 max-w-sm mx-auto">Aguardando nova especificação para desenvolvimento incremental.</p>
          </div>
        </motion.div>
      )}
    </div>
