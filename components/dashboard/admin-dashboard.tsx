...
export function AdminDashboard({ 
  ...
  const [rankingModalParams, setRankingModalParams] = React.useState<RankingContractModalParams | null>(null)
  const [isRankingModalOpen, setIsRankingModalOpen] = React.useState<boolean>(false)

  const handleOpenRankingModal = (params: RankingContractModalParams) => {
    setRankingModalParams({
  ...
  const fetchFinancialData = React.useCallback(async () => {
    ...
    try {
      ...
      if (filterUserId === '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639' || perfil?.id === '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639') {
        ...
        // Dates for previous months (July, June, May)
        const currentYear = today.getFullYear()
        const julyIso = new Date(currentYear, 6, 15).toISOString() // Month 6 = July (0-indexed)
        const juneIso = new Date(currentYear, 5, 15).toISOString() // Month 5 = June
        const mayIso = new Date(currentYear, 4, 15).toISOString()  // Month 4 = May
        ...
        const mockPjProps = [
          ...
          })),
          {
            ...
            percentual_comissao_pj: 3.25,
            comissao_pj_porcentagem: 3.25,
            valor_comissao_pj: 424.38,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: yesterdayIso,
          ...
          // Produção MÊS: 168.347,22 | Receita MÊS: 18.065,73
          {
          ...
          // ==================== JULHO (Produção: 129.563,21 | Comissão Total: 11.866,55) ====================
          // 9 contratos Prefeitura de SP | 7 contratos Governo de SP (Total = 16 contratos)
          // SENFF (10 contratos | Produção: 78.520,50 | Comissão 13%: 10.207,67)
          {
            id: `mock-senff-jul-1`,
            id_lead: `mock-senff-jul-lead-1`,
            cliente_nome: `Cliente Julho SENFF 1`,
            banco: 'SENFF',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 6500.00,
            valor_cliente: 6500.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 845.00,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
            created_at: julyIso,
            updated_at: julyIso,
            _effectiveStatus: 'RECEBIDO',
            _effectiveDate: julyIso,
            mock_tier: 'historico'
          },
          {
            id: `mock-senff-jul-2`,
            id_lead: `mock-senff-jul-lead-2`,
            cliente_nome: `Cliente Julho SENFF 2`,
            banco: 'SENFF',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 7120.50,
            valor_cliente: 7120.50,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 925.67,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
          ...
          {
            id: `mock-senff-jul-3`,
            id_lead: `mock-senff-jul-lead-3`,
            cliente_nome: `Cliente Julho SENFF 3`,
            banco: 'SENFF',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 7350.00,
            valor_cliente: 7350.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 955.50,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
          ...
          {
            id: `mock-senff-jul-4`,
            id_lead: `mock-senff-jul-lead-4`,
            cliente_nome: `Cliente Julho SENFF 4`,
            banco: 'SENFF',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 7680.00,
            valor_cliente: 7680.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 998.40,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
          ...
          {
            id: `mock-senff-jul-5`,
            id_lead: `mock-senff-jul-lead-5`,
            cliente_nome: `Cliente Julho SENFF 5`,
            banco: 'SENFF',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 7820.00,
            valor_cliente: 7820.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 1016.60,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
          ...
          {
            id: `mock-senff-jul-6`,
            id_lead: `mock-senff-jul-lead-6`,
            cliente_nome: `Cliente Julho SENFF 6`,
            banco: 'SENFF',
            convenio: 'Governo de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 7990.00,
            valor_cliente: 7990.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 1038.70,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
          ...
          {
            id: `mock-senff-jul-7`,
            id_lead: `mock-senff-jul-lead-7`,
            cliente_nome: `Cliente Julho SENFF 7`,
            banco: 'SENFF',
            convenio: 'Governo de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 8150.00,
            valor_cliente: 8150.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 1059.50,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
          ...
          {
            id: `mock-senff-jul-8`,
            id_lead: `mock-senff-jul-lead-8`,
            cliente_nome: `Cliente Julho SENFF 8`,
            banco: 'SENFF',
            convenio: 'Governo de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 8420.00,
            valor_cliente: 8420.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 1094.60,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
          ...
          {
            id: `mock-senff-jul-9`,
            id_lead: `mock-senff-jul-lead-9`,
            cliente_nome: `Cliente Julho SENFF 9`,
            banco: 'SENFF',
            convenio: 'Governo de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 8750.00,
            valor_cliente: 8750.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 1137.50,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
          ...
          {
            id: `mock-senff-jul-10`,
            id_lead: `mock-senff-jul-lead-10`,
            cliente_nome: `Cliente Julho SENFF 10`,
            banco: 'SENFF',
            convenio: 'Governo de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 8740.00,
            valor_cliente: 8740.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 1136.20,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
          ...
          // Safra Julho (6 contratos | Produção: 51.042,71 | Comissão 3,25%: 1.658,89)
          {
            id: `mock-safra-jul-1`,
            id_lead: `mock-safra-jul-lead-1`,
            cliente_nome: `Cliente Julho Safra 1`,
            banco: 'Safra',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Contrato novo',
            valor_operacao: 6900.00,
            valor_cliente: 6900.00,
            percentual_comissao_pj: 3.25,
            comissao_pj_porcentagem: 3.25,
            valor_comissao_pj: 224.25,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
          ...
          {
            id: `mock-safra-jul-2`,
            id_lead: `mock-safra-jul-lead-2`,
            cliente_nome: `Cliente Julho Safra 2`,
            banco: 'Safra',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Contrato novo',
            valor_operacao: 7450.00,
            valor_cliente: 7450.00,
            percentual_comissao_pj: 3.25,
            comissao_pj_porcentagem: 3.25,
            valor_comissao_pj: 242.13,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
          ...
          {
            id: `mock-safra-jul-3`,
            id_lead: `mock-safra-jul-lead-3`,
            cliente_nome: `Cliente Julho Safra 3`,
            banco: 'Safra',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Contrato novo',
            valor_operacao: 8120.00,
            valor_cliente: 8120.00,
            percentual_comissao_pj: 3.25,
            comissao_pj_porcentagem: 3.25,
            valor_comissao_pj: 263.90,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
          ...
          {
            id: `mock-safra-jul-4`,
            id_lead: `mock-safra-jul-lead-4`,
            cliente_nome: `Cliente Julho Safra 4`,
            banco: 'Safra',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Contrato novo',
            valor_operacao: 8750.00,
          ...
          {
            id: `mock-safra-jul-5`,
            id_lead: `mock-safra-jul-lead-5`,
            cliente_nome: `Cliente Julho Safra 5`,
            banco: 'Safra',
            convenio: 'Governo de SP',
            tipo_operacao: 'Contrato novo',
            valor_operacao: 9240.00,
            valor_cliente: 9240.00,
            percentual_comissao_pj: 3.25,
            comissao_pj_porcentagem: 3.25,
            valor_comissao_pj: 300.30,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
          ...
          {
            id: `mock-safra-jul-6`,
            id_lead: `mock-safra-jul-lead-6`,
            cliente_nome: `Cliente Julho Safra 6`,
            banco: 'Safra',
            convenio: 'Governo de SP',
            tipo_operacao: 'Contrato novo',
            valor_operacao: 10582.71,
            valor_cliente: 10582.71,
            percentual_comissao_pj: 3.25,
            comissao_pj_porcentagem: 3.25,
            valor_comissao_pj: 343.93,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: julyIso,
          ...
          // ==================== JUNHO (Produção: 111.088,94 | Comissão Total: 8.753,26) ====================
          // 8 contratos Prefeitura de SP | 4 contratos Governo de SP (Total = 12 contratos)
          // SENFF (6 contratos | Produção: 52.747,36 | Comissão 13%: 6.857,16)
          {
            id: `mock-senff-jun-1`,
            id_lead: `mock-senff-jun-lead-1`,
            cliente_nome: `Cliente Junho SENFF 1`,
            banco: 'SENFF',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 7420.00,
            valor_cliente: 7420.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 964.60,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: juneIso,
            created_at: juneIso,
            updated_at: juneIso,
            _effectiveStatus: 'RECEBIDO',
            _effectiveDate: juneIso,
            mock_tier: 'historico'
          },
          {
            id: `mock-senff-jun-2`,
            id_lead: `mock-senff-jun-lead-2`,
            cliente_nome: `Cliente Junho SENFF 2`,
            banco: 'SENFF',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 8015.36,
            valor_cliente: 8015.36,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 1041.99,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: juneIso,
          ...
          {
            id: `mock-senff-jun-3`,
            id_lead: `mock-senff-jun-lead-3`,
            cliente_nome: `Cliente Junho SENFF 3`,
            banco: 'SENFF',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 8450.00,
            valor_cliente: 8450.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 1098.50,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: juneIso,
          ...
          {
            id: `mock-senff-jun-4`,
            id_lead: `mock-senff-jun-lead-4`,
            cliente_nome: `Cliente Junho SENFF 4`,
            banco: 'SENFF',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 8900.00,
            valor_cliente: 8900.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 1157.00,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: juneIso,
          ...
          {
            id: `mock-senff-jun-5`,
            id_lead: `mock-senff-jun-lead-5`,
            cliente_nome: `Cliente Junho SENFF 5`,
            banco: 'SENFF',
            convenio: 'Governo de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 9540.00,
            valor_cliente: 9540.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 1240.20,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: juneIso,
          ...
          {
            id: `mock-senff-jun-6`,
            id_lead: `mock-senff-jun-lead-6`,
            cliente_nome: `Cliente Junho SENFF 6`,
            banco: 'SENFF',
            convenio: 'Governo de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 10422.00,
            valor_cliente: 10422.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 1354.86,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: juneIso,
          ...
          // Safra Junho (6 contratos | Produção: 58.341,58 | Comissão 3,25%: 1.896,10)
          {
            id: `mock-safra-jun-1`,
            id_lead: `mock-safra-jun-lead-1`,
            cliente_nome: `Cliente Junho Safra 1`,
            banco: 'Safra',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Contrato novo',
            valor_operacao: 7420.00,
          ...
          {
            id: `mock-safra-jun-2`,
            id_lead: `mock-safra-jun-lead-2`,
            cliente_nome: `Cliente Junho Safra 2`,
            banco: 'Safra',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Contrato novo',
            valor_operacao: 8150.00,
          ...
          {
            id: `mock-safra-jun-3`,
            id_lead: `mock-safra-jun-lead-3`,
            cliente_nome: `Cliente Junho Safra 3`,
            banco: 'Safra',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Contrato novo',
            valor_operacao: 9020.00,
            valor_cliente: 9020.00,
            percentual_comissao_pj: 3.25,
            comissao_pj_porcentagem: 3.25,
            valor_comissao_pj: 293.15,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: juneIso,
          ...
          {
            id: `mock-safra-jun-4`,
            id_lead: `mock-safra-jun-lead-4`,
            cliente_nome: `Cliente Junho Safra 4`,
            banco: 'Safra',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Contrato novo',
            valor_operacao: 9760.00,
            valor_cliente: 9760.00,
            percentual_comissao_pj: 3.25,
            comissao_pj_porcentagem: 3.25,
            valor_comissao_pj: 317.20,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: juneIso,
          ...
          {
            id: `mock-safra-jun-5`,
            id_lead: `mock-safra-jun-lead-5`,
            cliente_nome: `Cliente Junho Safra 5`,
            banco: 'Safra',
            convenio: 'Governo de SP',
            tipo_operacao: 'Contrato novo',
            valor_operacao: 10850.00,
            valor_cliente: 10850.00,
            percentual_comissao_pj: 3.25,
            comissao_pj_porcentagem: 3.25,
            valor_comissao_pj: 352.63,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: juneIso,
          ...
          {
            id: `mock-safra-jun-6`,
            id_lead: `mock-safra-jun-lead-6`,
            cliente_nome: `Cliente Junho Safra 6`,
            banco: 'Safra',
            convenio: 'Governo de SP',
            tipo_operacao: 'Contrato novo',
            valor_operacao: 13141.58,
            valor_cliente: 13141.58,
            percentual_comissao_pj: 3.25,
            comissao_pj_porcentagem: 3.25,
            valor_comissao_pj: 427.10,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: juneIso,
          ...
          // ==================== MAIO (Produção: 46.085,65 | Comissão Total: 3.551,00) ====================
          // 1 contrato Prefeitura de SP | 3 contratos Governo de SP (Total = 4 contratos)
          // SENFF (3 contratos | Produção: 21.058,66 | Comissão 13%: 2.737,63)
          {
            id: `mock-senff-mai-1`,
            id_lead: `mock-senff-mai-lead-1`,
            cliente_nome: `Cliente Maio SENFF 1`,
            banco: 'SENFF',
            convenio: 'Prefeitura de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 6150.00,
            valor_cliente: 6150.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 799.50,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: mayIso,
            created_at: mayIso,
            updated_at: mayIso,
            _effectiveStatus: 'RECEBIDO',
            _effectiveDate: mayIso,
            mock_tier: 'historico'
          },
          {
            id: `mock-senff-mai-2`,
            id_lead: `mock-senff-mai-lead-2`,
            cliente_nome: `Cliente Maio SENFF 2`,
            banco: 'SENFF',
            convenio: 'Governo de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 6890.66,
            valor_cliente: 6890.66,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 895.79,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: mayIso,
          ...
          {
            id: `mock-senff-mai-3`,
            id_lead: `mock-senff-mai-lead-3`,
            cliente_nome: `Cliente Maio SENFF 3`,
            banco: 'SENFF',
            convenio: 'Governo de SP',
            tipo_operacao: 'Cartão',
            valor_operacao: 8018.00,
            valor_cliente: 8018.00,
            percentual_comissao_pj: 13,
            comissao_pj_porcentagem: 13,
            valor_comissao_pj: 1042.34,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: mayIso,
          ...
          // Safra Maio (1 contrato | Produção: 25.026,99 | Comissão 3,25%: 813,38)
          {
            id: `mock-safra-mai-1`,
            id_lead: `mock-safra-mai-lead-1`,
            cliente_nome: `Cliente Maio Safra 1`,
            banco: 'Safra',
            convenio: 'Governo de SP',
            tipo_operacao: 'Contrato novo',
            valor_operacao: 25026.99,
            valor_cliente: 25026.99,
            percentual_comissao_pj: 3.25,
            comissao_pj_porcentagem: 3.25,
            valor_comissao_pj: 813.38,
            status: 'PÓS-VENDA REALIZADA',
            corretor_id: '77af8a7b-7cc2-43dd-b24d-b8a1e92c4639',
            corretor_regime: 'PJ',
            data_pago_cliente: mayIso,
  ...
  const getCommissionPercentage = React.useCallback((proposal: any) => {
    ...
    if (isCorretorPJ) {
      ...
      if (proposal.percentual_comissao_pj !== undefined && proposal.percentual_comissao_pj !== null && !isNaN(Number(proposal.percentual_comissao_pj))) {
      ...
      if (proposal.valor_comissao_pj !== undefined && proposal.valor_comissao_pj !== null) {
        ...
        if (valOp > 0) {
          return parseFloat(((Number(proposal.valor_comissao_pj) / valOp) * 100).toFixed(4))
        }
      }
    } else {
  ...
  const filteredFinancialProposals = React.useMemo(() => {
    return financialProposals.filter((proposal) => {
      ...
      if (proposal.mock_tier) {
        ...
        if (financialPeriod === 'semana' && (proposal.mock_tier === 'mes' || proposal.mock_tier === 'historico')) return false
        if (financialPeriod === 'mes' && proposal.mock_tier === 'historico') return false
    ...
    <div className="space-y-8">
      ...
      {activeTab === 'propostas' && (
        ...
        {estagioRankingGroup && estagioRankingGroup.colaboracoes?.estagiarios && estagioRankingGroup.colaboracoes.estagiarios.length > 0 && (() => {
          ...
          return (
            <div className="lg:col-span-12 space-y-6 mt-6" id="estagio-pj-ranking-card-admin">
              {/* RANKING ESTAGIÁRIOS */}
              {estagiariosList.length > 0 && (
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.35 }}>
                  <DashboardCard className="h-full shadow-lg shadow-[#1C2643]/5 flex flex-col bg-white !p-4.5 sm:!p-5 !rounded-[24px] border-slate-100">
                    <div className="flex items-center justify-between mb-8 pb-4 border-b border-slate-50">
                      <div className="flex items-center gap-3">
                        <h3 className="text-xl font-black text-[#1C2643] tracking-tighter uppercase">Ranking Estagiários</h3>
              ...
              {isOnlyAdmin && colaboradoresPJList.length > 0 && (
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.4 }}>
                  <DashboardCard className="h-full shadow-lg shadow-[#1C2643]/5 flex flex-col bg-white !p-4.5 sm:!p-5 !rounded-[24px] border-slate-100">
                    <div className="flex items-center justify-between mb-8 pb-4 border-b border-slate-50">
                      <div className="flex items-center gap-3">
                        <h3 className="text-xl font-black text-[#1C2643] tracking-tighter uppercase">Ranking Colaboradores PJ</h3>
                    ...
                    <div key={idx} className="space-y-1">
                      <div className="flex justify-between items-center text-[10px] font-black uppercase tracking-widest">
                        ...
                        <span className="text-slate-700">
                          {rank.value} ({percentage}%) <span className="text-orange-600 ml-2">{formatCurrency(rank.totalValue || 0)}</span>
                        </span>
                      </div>
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-4 pb-2 border-b border-slate-50">
                        <span className="text-[10px] font-black text-amber-500 bg-amber-50 px-2 py-1 rounded-lg uppercase tracking-wider">
                          {isCorretorPJ ? "Maior Produção Potencial" : "Maior Receita Potencial"}
                        </span>
                        <Trophy className="w-4 h-4 text-amber-500" />
                      </div>
                      
                      <h4 className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-3">
                        {isCorretorPJ ? "Quem gera maior potencial de produção?" : "Quem gera maior potencial de receita?"}
                      </h4>
                  ...
                  <div className="bg-white rounded-[24px] p-6 border border-slate-100 shadow-sm flex flex-col justify-between hover:shadow-md transition-all">
                    <div>
                      ...
                      <p className="text-xs font-bold text-slate-500 leading-relaxed mb-4">
                        {concentrationRisk ? (
                          <>
                            Detectamos que o {concentrationRisk.type.toLowerCase()} <span className="text-amber-600 font-extrabold uppercase">{concentrationRisk.name}</span> representa <span className="text-[#1C2643] font-extrabold">{concentrationRisk.share.toFixed(1)}%</span> {isCorretorPJ ? "da produção operacional dos chamados" : "da receita operacional dos chamados"}. Recomenda-se diversificar canais para atenuar o risco.
                          </>
                        ) : (
            ...
            {isProposalsStatsLoading ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                  ...
                  >
                    <div>
                      <p className="text-[10px] font-black text-purple-600 uppercase tracking-[0.2em] mb-1">Person. sua Proposta</p>
                  ...
                  {selectedProposalCard === 'total' ? (() => {
                    ...
                    (proposalsStats?.recentProposals || []).forEach((p: any) => {
                      ...
                      if (p.isQuitacao) {
                        ...
                        const val = parseFloat(p.valor_contrato);
                        const validVal = isNaN(val) ? 0 : val;
                        ...
                        <table className="w-full text-left border-collapse min-w-[800px]">
                          <thead>
                            <tr className="bg-slate-50/50 border-b border-slate-200">
                              ...
                              <th className="px-4 py-3 text-[10px] font-black text-purple-600 uppercase tracking-widest text-right bg-purple-50/20">Person. sua Proposta</th>
                            </tr>
                          </thead>
                          <tbody className="divide-y divide-slate-100">
                    ...
                    const groupedProposals = (() => {
                      ...
                      return Object.entries(groups).map(([groupKey, items]) => {
                        ...
                        if (selectedProposalCard === 'quitacao') {
                          ...
                          sum = sortedItems.reduce((acc, curr) => acc + (parseFloat(curr.valor_contrato) || 0), 0);
                        } else {
                              ...
                              >
                                ...
                                <div className="flex flex-col">
                                  {selectedProposalCard === 'quitacao' ? (
                                    ...
                                    <>
                                      <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest block mb-0.5">Soma dos Valores dos Contratos</span>
                                      <span className="text-sm font-black text-purple-600 font-mono leading-none">
                                        {formatCurrency(sum)}
                                      </span>
                                    </>
                                        ...
                                        return (
                                          ...
                                          >
                                            ...
                                            <div className="flex flex-col">
                                              ...
                                              <span className="text-sm font-black text-purple-600 font-mono leading-none">
                                                {item.valor_contrato ? formatCurrency(item.valor_contrato) : "--"}
                                              </span>
                                            </div>
